...
(function (W, X, u) {
    ...
    if (G(b)) {
      ...
      if ((c = je.exec(a))) b = [b.createElement(c[1])];
        ...
        if (Ib.test(a)) {
          ...
          e = da[e] || da._default;
          d.innerHTML =
            "<div>&#160;</div>" + e[1] + a.replace(le, "<$1></$2>") + e[2];
    ...
    this.$get = [
      ...
      function (a, b, l, n, q, p, s, J, w, t, y, K) {
        ...
        function O(a, b, c, d, e, f) {
          ...
          for (var k = [], p, l, m, q, n = 0; n < a.length; n++)
            (p = new Ob()),
              ...
              (f = l.length ? I(l, a[n], p, b, c, null, [], [], f) : null) &&
                f.scope &&
        ...
        function te(a, b, c, d, e, f, g, k) {
          ...
          b.empty();
          n.get(t.getTrustedResourceUrl(J), { cache: q })
            .success(function (q) {
              var n, t;
              q = W(q);
              if (s.replace) {
    ...
    var b = /^\s*(\[|\{[^\{])/,
      ...
      e = (this.defaults = {
        transformResponse: [
          function (d) {
            G(d) &&
              ((d = d.replace(c, "")), b.test(d) && a.test(d) && (d = ac(d)));
            return d;
          },
        ],
        transformRequest: [
    ...
    this.$get = [
      ...
      function (a, b, c, d, n, q) {
        ...
        function s(c, f, g) {
          function m(a, b, c, e) {
            C &&
              (200 <= a && 300 > a ? C.put(A, [a, b, tc(c), e]) : C.remove(A));
            q(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function q(a, b, d, e) {
  ...
  function Vd() {
    ...
    this.$get = [
      ...
      function (c, d, e, f) {
        ...
        a
          ? ((k =
              m.substring(0, m.indexOf("/", m.indexOf("//") + 2)) + (k || "/")),
            (e = e.history ? zc : Ac))
          : ((k = Ga(m)), (e = Tb));
        h = new e(k, "#" + b);
        h.$$parseLinkUrl(m, m);
        ...
        f.on("click", function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            ...
            l.test(e) ||
              ...
              (a.preventDefault(),
              h.absUrl() != d.url() &&
                (c.$apply(), (W.angular["ff-684208-preventDefault"] = !0)));
          }
        });
  ...
  function Hc(b) {
    ...
    return function (b, d) {
      ...
      return Lc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  isNaN(R) &&
    (R = U((/trident\/.*; rv:(\d+)/.exec(x(navigator.userAgent)) || [])[1]));
  v.$inject = [];
  ga.$inject = [];
  var L = (function () {
          ...
          link: function (e, g, h, k) {
            ...
            function n(e, f, g) {
              function h() {
                ...
                p ||
                  (z || null === s
                    ? a[""].unshift({ id: "", label: "", selected: !v })
                    : v || a[""].unshift({ id: "?", label: "", selected: !0 }));
                Q = 0;
